...
* A `SpatialPoints` or `SpatialPointsDataFrame` {[`sp`](https://CRAN.R-project.org/package=sp)} object with points representing landings,
...
* A `SpatialPolygons`or `SpatialPolygonsDataFrame` {[`sp`](https://CRAN.R-project.org/package=sp)} object with polygons representing landings, 
